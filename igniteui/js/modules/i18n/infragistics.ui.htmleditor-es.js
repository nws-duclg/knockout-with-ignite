...
if (!$.ig.HtmlEditor) {
	...
	$.extend($.ig.HtmlEditor, {
		...
		locale: {
			...
			increaseFontSizeButtonTitle: 'Aumentar tamano de fuente',
			decreaseFontSizeButtonTitle: 'Disminuir tamano de fuente',
			...
			bulletsButtonTitle: 'Vinetas',
			numberingButtonTitle: 'Numeracion',
			decreaseIndentButtonTitle: 'Disminuir sangria',
			increaseIndentButtonTitle: 'Aumentar sangria',
			...
			insertLinkButtonTitle: 'Insertar hipervinculo',
			...
			imageUrlDialogText: 'Direccion URL de la imagen:',
			...
			linkNavigateToUrlDialogText: 'Navegar a la direccion URL:',
