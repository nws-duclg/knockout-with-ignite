...
(function ($) {
    ...
    if (!$.ig.Tree) {
	    ...
	    $.extend($.ig.Tree, {
		    locale: {
			    invalidArgumentType: 'Ungultiger Argumenttyp angegeben.',
			    errorOnRequest: 'Beim Abrufen von Daten ist ein Fehler aufgetreten: ',
			    noDataSourceUrl: 'Fur die igTree Steuerung muss eine dataSourceUrl angegeben werden, um eine Anforderung fur Daten an diese URL zu initiieren.',
			    ...
			    setOptionError: 'Laufzeit-Anderungen sind fur die folgende Option nicht zugelassen: ',
